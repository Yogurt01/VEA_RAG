    ...
    return {
        ...
        "concept_details": {
            cid: {
                ...
                "audio_style": details.get("audio_style")[:150] if details.get("audio_style") else "",
                "visual_style": details.get("visual_style")[:150] if details.get("visual_style") else "",
