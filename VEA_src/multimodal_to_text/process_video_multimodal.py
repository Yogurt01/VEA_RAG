...
from prompts import QWEN_PROMPT_TEMPLATE, COHERENT_SCENE_SYSTEM_PROMPT
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_dir', type=str, default="/EnTube/Download_2min", help="Directory containing video folders.")
    ...
    parser.add_argument('--beat_checkpoint_path', type=str, default='/models/beats_checkpoints/BEATs_iter3_plus_AS2M_finetuned_on_AS2M_cpt2.pt')
    parser.add_argument('--qwen_visual_model_path', type=str, default='/models/Qwen3-VL-2B-Instruct')
    parser.add_argument('--qwen_instruct_model_path', type=str, default='/models/Qwen3-4B-Instruct-2507')
    parser.add_argument('--qwen_vl_embedding_model_path', type=str, default='/models/Qwen3-VL-Embedding-2B')
