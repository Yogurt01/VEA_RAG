...
def main():
    ...
    parser.add_argument('--root_dir', type=str, default="/EnTube_Small/Download_2min",
    ...
    parser.add_argument('--whisper_model_path', type=str, default='/models/faster-whisper-large-v2',
                        help='Tên mô hình Whisper hoặc Đường dẫn (Path) tới mô hình lưu tại local')
    parser.add_argument('--diarization_model_path', type=str, default='/models/speaker-diarization-community-1',
